  ...
  export default {
    ...
    render(h) {
      ...
      const scrollBtn = scrollable
        ? [
          <span class={['w-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="w-icon-triangle-left"></i></span>,
          <span class={['w-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="w-icon-triangle-right"></i></span>
        ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <span class="w-icon-close" on-click={(ev) => { onTabRemove(pane, ev); }}></span>
          : null;
        ...
        return (
          <div
            ...
            on-focus={ ()=> { setFocus(); }}
            on-blur ={ ()=> { removeFocus(); }}
            on-keydown={ (ev) => { setKeyDown(closable, pane, ev) }}
      ...
      return (
        <div class={['w-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${ this.rootTabs.tabPosition }`]}>
          {scrollBtn}
          <div class={['w-tabs__nav-scroll']} ref="navScroll">
            <div
