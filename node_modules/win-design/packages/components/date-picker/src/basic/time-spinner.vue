<template>
  <div class="w-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <w-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="w-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="w-time-spinner__list"
        tag="ul"
        ref="hours">
        <li
          @click="handleClick('hours', { value: hour, disabled: disabled })"
          v-for="(disabled, hour) in hoursList"
          class="w-time-spinner__item"
          :key="hour"
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="w-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="w-time-spinner__arrow w-icon-triangle-top"></i>
        <i v-repeat-click="increase" class="w-time-spinner__arrow w-icon-triangle-bottom"></i>
        <ul class="w-time-spinner__list" ref="hours">
          <li
            class="w-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="w-time-spinner__arrow w-icon-triangle-top"></i>
        <i v-repeat-click="increase" class="w-time-spinner__arrow w-icon-triangle-bottom"></i>
        <ul class="w-time-spinner__list" ref="minutes">
          <li
            class="w-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="w-time-spinner__arrow w-icon-triangle-top"></i>
        <i v-repeat-click="increase" class="w-time-spinner__arrow w-icon-triangle-bottom"></i>
        <ul class="w-time-spinner__list" ref="seconds">
          <li
