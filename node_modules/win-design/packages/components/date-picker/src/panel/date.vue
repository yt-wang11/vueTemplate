<template>
  <transition name="w-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="w-picker-panel w-date-picker w-popper"
      :class="[{
      ...
      <div class="w-picker-panel__body-wrapper">
        ...
        <div class="w-picker-panel__body">
          <div class="w-date-picker__time-header" v-if="showTime">
            ...
            <span class="w-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <w-input
                ref="input"
          ...
          <div
            ...
            :class="{ 'w-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              aria-label="前一年"
              class="w-picker-panel__icon-btn w-date-picker__prev-btn w-icon-triangle-left y-icon">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              aria-label="上个月"
              class="w-picker-panel__icon-btn w-date-picker__prev-btn w-icon-triangle-left d-icon">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="w-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="w-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{month + 1 }} 月</span>
            <button
              type="button"
              @click="nextYear"
              aria-label="后一年"
              class="w-picker-panel__icon-btn w-date-picker__next-btn w-icon-triangle-right y-icon">
            </button>
            <button
              type="button"
              @click="nextMonth"
              v-show="currentView === 'date'"
              aria-label="下个月"
              class="w-picker-panel__icon-btn w-date-picker__next-btn w-icon-triangle-right d-icon">
            </button>
          </div>
          <div class="w-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, WInput, WButton
    },
