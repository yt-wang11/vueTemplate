<template>
  <transition name="w-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="w-picker-panel w-date-range-picker w-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="w-picker-panel__body-wrapper">
        <slot name="sidebar" class="w-picker-panel__sidebar"></slot>
        <div class="w-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="w-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="w-picker-panel__body">
          <div class="w-date-range-picker__time-header" v-if="showTime">
            <span class="w-date-range-picker__editors-wrap">
              <span class="w-date-range-picker__time-picker-wrap">
                <w-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  placeholder="开始日期"
                  class="w-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="w-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <w-input
                  size="small"
                  class="w-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="w-date-range-picker__editors-wrap is-right">
              <span class="w-date-range-picker__time-picker-wrap">
                <w-input
                  size="small"
                  class="w-date-range-picker__editor"
              ...
              <span class="w-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <w-input
                  size="small"
                  class="w-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="w-picker-panel__content w-date-range-picker__content is-left">
            <div class="w-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="w-picker-panel__icon-btn w-icon-triangle-left arrow-left-y"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="w-picker-panel__icon-btn w-icon-triangle-left arrow-left-d"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="w-picker-panel__icon-btn w-icon-triangle-right arrow-right-y"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="w-picker-panel__icon-btn w-icon-triangle-right arrow-right-d"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="w-picker-panel__content w-date-range-picker__content is-right">
            <div class="w-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="w-picker-panel__footer" v-if="showTime">
        <w-button
          size="medium"
          type="text"
...
<script type="text/babel">
  ...
  export default {
      ...
      handleDateInput(value, type) {
        ...
        if (parsedValue) {
          if (typeof this.disabledDate === 'function' &&
            this.disabledDate(new Date(parsedValue))) return;
          if (type === 'min') {
    ...
    components: { TimePicker, DateTable, WInput, WButton }
  };
</script>
