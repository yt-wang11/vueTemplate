<template>
  <transition
    ...
    <div
      v-show="visible"
      class="w-time-range-picker w-picker-panel w-popper"
      :class="popperClass">
      <div class="w-time-range-picker__content">
        <div class="w-time-range-picker__cell">
          <div class="w-time-range-picker__header">开始时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="w-time-range-picker__body w-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="w-time-range-picker__cell">
          <div class="w-time-range-picker__header">结束时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="w-time-range-picker__body w-time-panel__content">
            <time-spinner
      ...
      <div class="w-time-panel__footer">
        <button
          type="button"
          class="w-time-panel__btn cancel"
          @click="handleCancel()">取消</button>
        <button
          type="button"
          class="w-time-panel__btn confirm"
          @click="handleConfirm()"
