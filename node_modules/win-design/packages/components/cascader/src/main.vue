<template>
  <span
    ...
    :class="[
      ...
      cascaderSize ? 'w-cascader--' + cascaderSize : ''
    ]"
    @click="handleClick"
  ...
  >
    ...
    <template slot="suffix">
        <i
          ...
          class="w-input__icon w-icon-close"
          @click="clearValue"
        ></i>
        <i
          key="2"
          v-else
          class="w-input__icon w-icon-triangle-bottom"
          :class="{ 'is-reverse': menuVisible }"
        ></i>
      </template>
    </w-input>
    <span class="w-cascader__label" v-show="inputValue === '' && !isOnComposition">
...
import { generateId, escapeRegexpString, isIE, isEdge } from '../../../utils/utils'
