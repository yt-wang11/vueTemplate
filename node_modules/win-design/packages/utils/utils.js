...
export const getValueByProp = (obj, prop) => {
...
export const setValueByPath = (obj, prop, value) => {
  let temp = obj
  if (prop.indexOf('.') === -1) {
    temp[prop] = value
    return
...
export const findAncestorNode = (currentParent, ancestorName) => {
...
export const getParentsCounter = ({context, root, target}) => {
  let counter = 0
