...
exports.default = {
  ...
  computed: {
    ...
    ancestor: function ancestor() {
      return (0, _utils.findAncestorNode)(this.$parent, 'WRadioGroup');
    },
...
var _radio = __webpack_require__(434);
...
_radio2.default.install = function (Vue) {
  Vue.install(_radio2.default.name, _radio2.default);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_radio_vue__ = __webpack_require__(257);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e884f6c2_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_radio_vue__ = __webpack_require__(435);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e884f6c2_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_radio_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{class:['w-radio', {
  'is-disabled': _vm.disabled,
  'is-checked': _vm.model !== undefined && _vm.model === _vm.label,
  'is-border': _vm.border
}]},[_c('span',{class:['w-radio__input']},[_c('span',{staticClass:"w-radio__inner"}),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.model),expression:"model"}],staticClass:"w-radio__native",attrs:{"type":"radio","name":_vm.name,"disabled":_vm.disabled},domProps:{"value":_vm.label,"checked":_vm._q(_vm.model,_vm.label)},on:{"change":[function($event){_vm.model=_vm.label},_vm.handleChange]}})]),_c('span',{staticClass:"w-radio__label"},[_vm._t("default"),(!_vm.$slots.default)?_c('span',{domProps:{"textContent":_vm._s(_vm.label)}}):_vm._e()],2)])}
var staticRenderFns = []
