...
exports.default = {
  ...
  computed: {
    typeClass: function typeClass() {
      return this.type && !this.iconClass ? 'w-icon w-icon-' + typeMap[this.type] + ' w-message__' + typeMap[this.type] : '';
    },
...
var _main = __webpack_require__(408);
...
var _vdom = __webpack_require__(411);
...
var Message = function Message(options) {
  ...
  // 对应main.vue文件中主Div为v-show，若为v-if获取不到Dom
  instance.$el.style.zIndex = _popup.PopupManager.nextZIndex();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__ = __webpack_require__(250);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05e1cadc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(410);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05e1cadc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"w-message-fade"},on:{"after-leave":_vm.handleAfterLeave}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],staticClass:"w-message",class:[
        _vm.type && !_vm.iconClass ? ("w-message--" + _vm.type) : '',
        _vm.center ? 'is-center' : '',
        _vm.showClose ? 'is-closable' : '',
        _vm.customClass
        ],style:(_vm.positionStyle),on:{"mouseenter":_vm.clearTimer,"mouseleave":_vm.startTimer}},[(_vm.iconClass)?_c('i',{class:_vm.iconClass}):_c('i',{staticClass:"w-message__leftIcon",class:_vm.typeClass}),_vm._t("default",[(!_vm.dangerouslyUseHTMLString)?_c('p',{staticClass:"w-message__content"},[_vm._v(_vm._s(_vm.message))]):_c('p',{staticClass:"w-message__content",domProps:{"innerHTML":_vm._s(_vm.message)}})]),(_vm.showClose)?_c('i',{staticClass:"w-message__closeBtn w-icon-close",on:{"click":_vm.close}}):_vm._e()],2)])}
var staticRenderFns = []
...
function isVNode(node) {
  return node !== null && (typeof node === 'undefined' ? 'undefined' : (0, _typeof3.default)(node)) === 'object' && (0, _utils.hasOwn)(node, 'componentOptions');
}
