...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_vue__ = __webpack_require__(244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6ddee7c6_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__ = __webpack_require__(393);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6ddee7c6_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__["a" /* default */],
...
var _directive = __webpack_require__(392);
...
var _afterLeave = __webpack_require__(245);
...
loadingDirective.install = function (Vue) {
  ...
  var toggleLoading = function toggleLoading(el, binding) {
    if (binding.value) {
      ...
      (0, _afterLeave2.default)(el.instance, function (_) {
        ...
        (0, _dom.removeClass)(target, 'w-loading-parent--relative');
        (0, _dom.removeClass)(target, 'w-loading-parent--hidden');
  ...
  var insertDom = function insertDom(parent, el, binding) {
    if (!el.domVisible && (0, _dom.getStyle)(el, 'display') !== 'none' && (0, _dom.getStyle)(el, 'visibility') !== 'hidden') {
      ...
      if (el.originalPosition !== 'absolute' && el.originalPosition !== 'fixed') {
        (0, _dom.addClass)(parent, 'w-loading-parent--relative');
      }
      if (binding.modifiers.fullscreen && binding.modifiers.lock) {
        (0, _dom.addClass)(parent, 'w-loading-parent--hidden');
      }
      el.domVisible = true;
  ...
  Vue.directive('loading', {
    bind: function bind(el, binding, vnode) {
      var textExr = el.getAttribute('win-loading-text');
      var sizeExr = el.getAttribute('win-loading-size');
      var spinnerExr = el.getAttribute('win-loading-spinner');
      var backgroundExr = el.getAttribute('win-loading-background');
      var customClassExr = el.getAttribute('win-loading-custom-class');
    ...
    update: function update(el, binding) {
      el.instance.setText(el.getAttribute('win-loading-text'));
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"w-loading-fade"},on:{"after-leave":_vm.handleAfterLeave}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],staticClass:"w-loading-mask",class:[_vm.customClass, { 'is-fullscreen': _vm.fullscreen }],style:({ backgroundColor: _vm.background || '' })},[_c('div',{staticClass:"w-loading-spinner",class:!_vm.fullscreen ? ("is-" + (_vm.size ? _vm.size : 'medium')) : ''},[(!_vm.spinner)?_c('svg',{staticClass:"circular",attrs:{"viewBox":"25 25 50 50"}},[_c('circle',{staticClass:"path",attrs:{"cx":"50","cy":"50","r":"20","fill":"none"}})]):_c('i',{class:_vm.spinner}),(_vm.text)?_c('p',{staticClass:"w-loading-text"},[_vm._v(_vm._s(_vm.text))]):_vm._e()])])])}
var staticRenderFns = []
