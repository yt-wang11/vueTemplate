...
var _tabNav = __webpack_require__(489);
...
exports.default = {
  ...
  render: function render(h) {
    ...
    var header = h(
      'div',
      { 'class': ['w-tabs__header', 'is-' + tabPosition] },
      [newButton, h(
        'tab-nav',
        navData,
        []
    ...
    return h(
      ...
      { 'class': (_ref = {
          'w-tabs': true,
          'w-tabs--card': type === 'card'
        }, (0, _defineProperty3.default)(_ref, 'w-tabs--' + tabPosition, true), (0, _defineProperty3.default)(_ref, 'w-tabs--border-card', type === 'border-card'), _ref) },
    ...
    calcPaneInstances: function calcPaneInstances() {
      ...
      if (this.$slots.default) {
        var paneSlots = this.$slots.default.filter(function (vnode) {
          return vnode.tag && vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'WTabPane';
        });
        // update indeed
...
var _tabBar = __webpack_require__(490);
...
exports.default = {
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      'span',
      { 'class': ['w-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled'], on: {
          'click': scrollPrev
        }
      },
      [h(
        'i',
        { 'class': 'w-icon-triangle-left' },
        []
      )]
    ), h(
      'span',
      { 'class': ['w-tabs__nav-next', scrollable.next ? '' : 'is-disabled'], on: {
          'click': scrollNext
        }
      },
      [h(
        'i',
        { 'class': 'w-icon-triangle-right' },
        []
      )]
    )] : null;
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      return h(
        'div',
        {
          'class': (_ref = {
            'w-tabs__item': true
          }, (0, _defineProperty3.default)(_ref, 'is-' + _this2.rootTabs.tabPosition, true), (0, _defineProperty3.default)(_ref, 'is-active', pane.active), (0, _defineProperty3.default)(_ref, 'is-disabled', pane.disabled), (0, _defineProperty3.default)(_ref, 'is-closable', closable), (0, _defineProperty3.default)(_ref, 'is-focus', _this2.isFocus), _ref),
    ...
    return h(
      'div',
      { 'class': ['w-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', 'is-' + this.rootTabs.tabPosition] },
      [scrollBtn, h(
        'div',
        { 'class': ['w-tabs__nav-scroll'], ref: 'navScroll' },
        [h(
          'div',
          {
            'class': ['w-tabs__nav', 'w-tabs__' + size, 'is-' + this.rootTabs.tabPosition, stretch && ['top', 'bottom'].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : ''],
            ref: 'nav',
            style: navStyle,
            attrs: { role: 'tablist'
            },
  ...
  methods: {
    ...
    setKeyDown: function setKeyDown(closable, pane, ev) {
  ...
  computed: {
    barStyle: function barStyle() {
      ...
      this.tabs.every(function (tab, index) {
        var $el = (0, _utils.arrayFind)(_this.$parent.$refs.tabs || [], function (t) {
...
var _tabs = __webpack_require__(488);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_tab_nav_vue__ = __webpack_require__(270);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_tab_bar_vue__ = __webpack_require__(271);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_330777c7_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_tab_bar_vue__ = __webpack_require__(491);
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_330777c7_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_tab_bar_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"w-tabs__active-bar",class:("is-" + (_vm.rootTabs.tabPosition)),style:(_vm.barStyle)})}
var staticRenderFns = []
