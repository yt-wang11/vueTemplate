...
exports.scrollToElement = exports.getOffsetTop = exports.scrollToTop = exports.scrollTo = undefined;
...
var DefaultDuration = 450; // 默认持续时间
var QuadEaseIn = function QuadEaseIn(t, b, c, d) {
  /**
   * 缓动函数
   * Tween.js
...
var scrollTo = exports.scrollTo = function scrollTo(to) {
  ...
  var b = container === window ? isClient() && window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement.scrollTop : container.scrollTop; // 初始值
  var c = to - b;
  var d = duration;
  var start = null;

  var setScrollTop = function setScrollTop(val) {
...
var scrollToTop = exports.scrollToTop = function scrollToTop(duration, container) {
  /**
   * 滚动到顶部
   * @param {Number} duration 动画时间
   * @param {Object} container 容器DOM 默认window
...
var getOffsetTop = exports.getOffsetTop = function getOffsetTop(target, getContainer) {
  /**
...
var scrollToElement = exports.scrollToElement = function scrollToElement(target) {
  var getContainer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {
    return window;
  };
...
var _smoothScroll = __webpack_require__(186);
...
exports.default = {
  ...
  computed: {},
  methods: {
    computedItemTop: function computedItemTop(target) {
      if (!target) return;
      var anchorTop = _smoothScroll2.default.getOffsetTop(this.$refs.anchor, this.getContainer);
      var linkItemHeight = getComputedStyle(this.$refs['anchor-item']).height.replace('px', '') * 1 || 8;
      var linkHeight = target.clientHeight || 0;
      var linkTop = _smoothScroll2.default.getOffsetTop(target, this.getContainer);
    ...
    handleActivedLink: function handleActivedLink(target, selector) {
  ...
  mounted: function mounted() {
    ...
    this.$on('linkHover', function (_ref) {
      var ev = _ref.ev,
          selector = _ref.selector;

      _this2.handleActivedLink(ev.target, selector);
    });
    this.$on('linkClick', function (_ref2) {
      var ev = _ref2.ev,
          link = _ref2.link;

      _this2.$emit('onLinkClick', { ev: ev, link: link });
      _this2.actived = link.actived || '';
    });
    this.$on('addLink', function (val) {
      var top = _smoothScroll2.default.getOffsetTop(document.querySelector(val), _this2.getContainer);
      _this2.links.push((0, _defineProperty3.default)({}, val, top || 0));
    });
...
var _anchor = __webpack_require__(285);
...
_anchor2.default.install = function (Vue) {
  Vue.install(_anchor2.default.name, _anchor2.default);
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_anchor_vue__ = __webpack_require__(211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_02f9950e_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_anchor_vue__ = __webpack_require__(286);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_02f9950e_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_anchor_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"anchor",staticClass:"w-anchor",style:(_vm.anchorPosition)},[_c('span',{directives:[{name:"show",rawName:"v-show",value:(_vm.showItem),expression:"showItem"}],ref:"anchor-item",class:['w-anchor__item', {
    'is-actived': _vm.actived === _vm.currentLink
  }],style:(("top: " + _vm.itemTop + "px"))}),_vm._t("default")],2)}
var staticRenderFns = []
